...
<p align="center">
  <a href="https://github.com/JarolGabriel/neon-shop">
    <img src="https://img.shields.io/github/stars/JarolGabriel/neon-shop?style=for-the-badge&logo=github&color=181717" alt="GitHub Stars" />
  </a>
  <a href="https://github.com/JarolGabriel/neon-shop/blob/main/LICENSE">
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Resend-Email-000?style=flat-square" alt="Resend" />
  <img src="https://img.shields.io/badge/Vercel-Deploy-000?style=flat-square&logo=vercel&logoColor=white" alt="Vercel" />
</p>
<p align="center">
  <a href="https://github.com/JarolGabriel/neon-shop"><strong>Ver repositorio</strong></a>
  ·
  <a href="#-inicio-rápido">Inicio rápido</a>
  ·
  <a href="#-rutas-de-la-aplicación">Rutas</a>
  ·
  <a href="#-base-de-datos-y-migraciones">Migraciones</a>
  ·
...
src/ ├── app/ │ ├── (public)/ # Tienda, showroom, carrito, personalizador │ ├── (admin)/admin/ # Panel de administración │ ├── (auth)/ # Login, registro, perfil │ └── api/ # Backend REST (no consumir Supabase desde el cliente) ├── components/ │ ├── ui/ # shadcn/ui │ ├── shared/ # Navbar, Footer, etc. │ ├── store/ # Componentes de la tienda │ ├── admin/ # Componentes del admin │ └── showroom/ # Feed social ├── context/ # AuthContext, CartContext ├── hooks/ # useCart, useAuth, useProducts, etc. ├── lib/ # api.ts, utils, pricing, WhatsApp helpers └── types/ # Tipos TypeScript + Supabase generated
...
| `/comunidad` | Promos y contenido comunitario (mobile) |
...
URL pública (http://localhost:3000 en dev)
ADMIN_EMAILS
Emails que reciben rol admin al registrarse
...
20260522023206_add_custom_designs_table.sql
20260524002620_create_orders_tables.sql
...
Abre SQL Editor en tu proyecto Supabase.
Ejecuta cada archivo de supabase/migrations/ en orden (por timestamp en el nombre).
Verifica con:
...
Comando	Descripción
npm run dev
Servidor de desarrollo (0.0.0.0:3000)
npm run build
Build de producción
npm run start
...
npm run lint
ESLint
npm run seed:showroom
Seed de posts de showroom
npm run seed:showroom:clean
Limpia seed de showroom
Flujo de compra
Catálogo
Carrito
Checkout / formulario
...
/mi-pedido
WhatsApp prellenado
El usuario completa datos de entrega.
El backend crea la orden y vacía el carrito.
Se muestra confirmación con link a WhatsApp usando whatsapp_number de settings.
...
Despliegue (Vercel)
Importa el repo JarolGabriel/neon-shop en Vercel.
Configura todas las variables de .env.example.
Asegura que las migraciones ya están aplicadas en Supabase de producción.
Verifica dominio en Resend para emails en producción.
Deploy.
...
Rol	Acceso
customer
Tienda, carrito, showroom, favoritos, perfil
admin
Todo lo anterior + /admin/*
...
Respeta las convenciones en .cursorrules (API centralizada, sin Supabase en cliente, RHF + Zod).
Abre PR con descripción y plan de prueba.
Licencia
Proyecto privado — todos los derechos reservados.

Desarrollado con Next.js y Supabase · github.com/JarolGabriel/neon-shop

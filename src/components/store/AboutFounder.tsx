...
const FOUNDER_PARAGRAPHS = [
  "Desde 2024, Neon Shop. ha facilitado y es asequible a la creación de letreros de neón personalizados de alta calidad, tan elegantes como duraderos.",
        ...
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-12">
          <figure className="md:col-span-5">
            ...
            <figcaption className="mt-4 text-center text-base font-bold text-foreground sm:text-lg">
              Frank Siras, Neon Shop Co-fundador
            </figcaption>
          </figure>

...
interface ShowroomImageDropzoneProps {
  value: File | null;
  onChange: (file: File | null) => void;
  disabled?: boolean;
}

export function ShowroomImageDropzone({
  value,
  onChange,
  disabled = false,
}: ShowroomImageDropzoneProps) {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isDragActive
          ? "border-neon-pink bg-neon-pink/5 dark:border-cyber-yellow dark:bg-cyber-yellow/5"
